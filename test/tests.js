...
describe("Purchases",function(){
  it("should return a map of all purchases for each week",function(){
    ...
    assert.deepEqual(result,{week1:[ { item: 'Chakalaka Can', quantity: '3', totalCost: 'R21,00' },
  ...
  { item: 'Top Class Soy Mince',
    quantity: '3',
    totalCost: 'R33,00' } ],week2:[ { item: 'Chakalaka Can', quantity: '3', totalCost: 'R21,00' },
  { item: 'Coke 500ml', quantity: '3', totalCost: 'R10,50' },
  { item: 'Cream Soda 500ml', quantity: '4', totalCost: 'R18,00' },
  { item: 'Fanta 500ml', quantity: '2', totalCost: 'R9,00' },
  { item: 'Gold Dish Vegetable Curry Can',
  ...
  { item: 'Top Class Soy Mince',
    ...
    totalCost: 'R120,00' },
  { item: 'Shampoo 1 litre', quantity: '2', totalCost: 'R40,00' },
  { item: 'Valentine Cards', quantity: '20', totalCost: 'R40,00' },
  { item: 'Milk 1l', quantity: '3', totalCost: 'R28,50' },
  { item: 'Bananas - loose', quantity: '4', totalCost: 'R4,00' },
  { item: 'Mixed Sweets 5s', quantity: '50', totalCost: 'R150,00' },
  { item: 'Shampoo 1 litre', quantity: '3', totalCost: 'R60,00' },
  ...
  { item: 'Top Class Soy Mince',
    quantity: '3',
    totalCost: 'R33,00' } ],week3:[ { item: 'Chakalaka Can', quantity: '3', totalCost: 'R21,00' },
  { item: 'Coke 500ml', quantity: '3', totalCost: 'R10,50' },
  { item: 'Cream Soda 500ml', quantity: '4', totalCost: 'R18,00' },
  { item: 'Fanta 500ml', quantity: '2', totalCost: 'R9,00' },
  { item: 'Gold Dish Vegetable Curry Can',
  ...
  { item: 'Top Class Soy Mince',
    quantity: '3',
    totalCost: 'R33,00' } ],week4:[ { item: 'Chakalaka Can', quantity: '2', totalCost: 'R9,00' },
  { item: 'Coke 500ml', quantity: '2', totalCost: 'R10,00' },
  { item: 'Cream Soda 500ml', quantity: '1', totalCost: 'R17,00' },
  { item: 'Fanta 500ml', quantity: '3', totalCost: 'R60,00' },
  { item: 'Gold Dish Vegetable Curry Can',
    quantity: '4',
    totalCost: 'R28,00' },
  { item: 'Gold Dish Vegetable Curry Can',
    quantity: '5',
    totalCost: 'R40,00' },
  { item: 'Imasi', quantity: '4', totalCost: 'R4,00' },
  { item: 'Iwisa Pap 5kg', quantity: '10', totalCost: 'R15,00' },
  { item: 'Milk 1l', quantity: '60', totalCost: 'R180,00' },
  { item: 'Top Class Soy Mince',
    quantity: '15',
    totalCost: 'R105,00' },
  { item: 'Top Class Soy Mince',
    quantity: '36',
    totalCost: 'R126,00' },
  { item: 'Bananas - loose', quantity: '3', totalCost: 'R10,50' },
  { item: 'Apples - loose', quantity: '3', totalCost: 'R21,00' },
  { item: 'Mixed Sweets 5s', quantity: '1', totalCost: 'R20,00' },
  { item: 'Shampoo 1 litre', quantity: '3', totalCost: 'R9,00' },
  { item: 'Soap Bar', quantity: '30', totalCost: 'R270,00' },
  { item: 'Bread', quantity: '4', totalCost: 'R18,00' },
  { item: 'Chakalaka Can', quantity: '2', totalCost: 'R9,00' },
  { item: 'Coke 500ml', quantity: '2', totalCost: 'R10,00' },
  { item: 'Cream Soda 500ml', quantity: '1', totalCost: 'R17,00' },
  { item: 'Fanta 500ml', quantity: '3', totalCost: 'R60,00' },
  { item: 'Gold Dish Vegetable Curry Can',
