exports.weeklySales3 = function(folderName){
var fs = require('fs'); //file system
var inputSales = fs.readFileSync('./CSV/week3.csv', "utf8"); //gets the first weeks contents
...
var weeklySales3 = []; //has stockItem and amount sold mapped
