exports.weeklySales4 = function(folderName){
var fs = require('fs'); //file system
var inputSales = fs.readFileSync('./CSV/week4.csv', "utf8"); //gets the first weeks contents
...
var weeklySales4 = []; //has stockItem and amount sold mapped
